...
export const translations: Translations = {
  ...
  'hero.greeting': { en: 'Dominik Zarsky' },
  'hero.title': { en: 'Full Stack Developer and DevOps Engineer' },
  'hero.description': {
    en: 'I build modern web applications with focus on performance and user experience. As a DevOps engineer, I mainly focus on Azure Cloud, CI/CD, Infrastructure as Code, and automation.',
  },
  'hero.getInTouch': { en: 'Get in Touch' },
  'hero.downloadCV': { en: 'Download CV' },
